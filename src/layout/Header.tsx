...
const Header = () => {
  ...
  return (
    <Box style={{ boxShadow: scrolled ? "0px 0px 50px 1px rgba(200, 220, 4, 0.179)" : "none" }} className={`pt-3! pb-[11px]! px-4! sticky h-[71px]! top-0 left-0 ${scrolled && "bg-[#2C0147]! shadow shadow-amber-300"} z-50`} color="white">
