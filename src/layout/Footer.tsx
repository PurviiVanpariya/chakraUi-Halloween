import { Box, Container, Flex, Grid, Image, NativeSelect, Text } from "@chakra-ui/react"
...
const Footer = () => {
  return (
    <Box id="contact" className="relative overflow-hidden!">
      <Image src="/src/assets/images/contactLeftSide.png" alt="Spider" className="absolute -left-[242px] z-20" />
      <Box bg="#411B58" className="py-[60px]! relative overflow-hidden!">
        ...
        <Container maxW={1150} px={3.5} display="flex" justifyContent="center" alignItems="center" flexDirection="column">
          ...
          <Grid templateColumns="repeat(2, 1fr)" gap={4} width="100%" my={7}>
            <OutlinedInput className="px-5! text-[#CCCCCC]!" placeholder="Dasda" width="100%" height="30px" />
            <OutlinedInput className="px-5! text-[#CCCCCC]!" placeholder="Guest Email Address" width="100%" height="30px" />
            <OutlinedInput className="px-5! text-[#CCCCCC]!" placeholder="Guest Mobile Number" width="100%" height="30px" />
            <NativeSelect.Root>
              <NativeSelect.Field
                className="px-5!"
                borderRadius="0"
              ...
              >
                ...
                <option className="text-[#555555]" value="react">Ticket Plan</option>
                <option className="text-[#555555]" value="vue">Single Entry</option>
                <option className="text-[#555555]" value="angular">Couple Entry</option>
                <option className="text-[#555555]" value="svelte">Combine Entry</option>
              </NativeSelect.Field>
              <NativeSelect.Indicator className="text-[#CCCCCC]!" />
            </NativeSelect.Root>
          </Grid>
      ...
      <Box bg="#2c0047" className="pt-[60px]!  relative">
        <Image src="/src/assets/images/spider.png" alt="Spider" className="absolute pointer-events-none -top-52 left-1/2 transform -translate-x-1/2" />
        <Container maxW={1150} px={3.5} display="flex" justifyContent="center" alignItems="center" flexDirection="column">
          <Text className="text-primary text-[32px]!" mb={8}>Signup For Newsletter</Text>
        ...
        <Box borderTop="1px solid #6c4d7f" className="h-[65px]!" display="flex" alignItems="center" justifyContent="center">
          <Text className="text-primary text-sm! font-sans!" display="flex" justifyContent="center" alignItems="center">
